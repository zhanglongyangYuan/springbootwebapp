...
(function () {
    ...
    new MutationObserver(e => {
        for (const n of e) if (n.type === "childList") for (const a of n.addedNodes) a.tagName === "LINK" && a.rel === "modulepreload" && t(a)
...
const we = {key: 0, class: "mt-3"},
    _e = d("span", {class: "rounded px-1 py-0.5 border text-xs font-bold bg-yellow-400 border-yellow-400 text-gray-800"}, "", -1),
    Ce = d("span", {class: "px-1 font-bold"}, "", -1), Se = ["href"], Ie = {
        __name: "广告", setup(W) {
    ...
    }, Re = {class: "my-4 px-4 sm:px-6"}, Ke = {class: "bg-white dark:bg-gray-900"},
    je = {key: 0, class: "border dark:border-gray-900 rounded-md"}, qe = {
        key: 0,
    ...
    }, Ae = d("span", {class: "pr-4 grow-0 shrink-0 w-10 sm:w-12"}, "ME:", -1), ze = {class: "grow dark:text-gray-300"},
    Fe = ["onClick"],
    Me = {key: 1, class: "px-4 sm:px-8 py-4 flex flex-row text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800"},
    Je = d("span", {class: "font-semibold pr-4 grow-0 shrink-0 w-10 sm:w-12"}, "AI:", -1),
    Oe = {class: "grow whitespace-pre-wrap"}, Te = {key: 0}, Ne = {key: 1}, Ge = {key: 2},
    Le = {key: 3, class: "blink"}, $e = ["onClick"], Ee = {key: 1, class: "py-24"}, Be = d("svg", {
    ...
    He = [Be, Pe], De = {
        __name: "Dialogs", props: {messages: Array, loading: Boolean}, setup(W) {
            ...
            }, "复制", 8, Fe)])) : j("", !0), e.who === "AI" ? (y(), w("div", Me, [Je, d("div", Oe, [d("div", null, [n !== W.messages.length - 1 && e.message.trim().length === 0 ? (y(), w("span", Te, " AI 也不知道该说啥了，祝你平安吧~ ")) : j("", !0), !W.loading && n === W.messages.length - 1 && e.message.trim().length === 0 ? (y(), w("span", Ne, " AI 也不知道该说啥了，祝你平安吧~ ")) : (y(), w("span", Ge, J(e.message.trim()), 1)), W.loading && n === W.messages.length - 1 ? (y(), w("span", Le)) : (y(), le(Ie, {key: 4}))])]), W.loading && n === W.messages.length - 1 ? j("", !0) : (y(), w("span", {
                key: 0,
                class: "grow-0 shrink-0 w-10 sm:w-12 text-right font-normal text-gray-400 active:text-gray-500 dark:text-gray-500 active:dark:text-gray-600 text-sm",
                onClick: a => b(e.message.trim())
            }, "复制", 8, $e))])) : j("", !0)], 2))), 128))])) : (y(), w("div", Ee, He))])]))
        }
    }, Qe = {class: "relative py-20 sm:py-24 bg-white dark:bg-gray-800"}, Ve = {class: "max-w-5xl mx-auto"},
    Ze = ["onSubmit"], Xe = d("button", {
        type: "submit",
    ...
    Ue = {key: 0, class: "text-gray-500 px-4 sm:px-6 pt-1 flex flex-row items-center text-sm dark:text-gray-400"},
    Ye = {class: "pl-1 sm:pl-2"}, et = d("span", null, "总：", -1), tt = {class: "ml-3"}, nt = d("span", null, "已用：", -1),
    rt = {class: "ml-3"}, ot = d("span", null, "剩余：", -1),
    at = {key: 1, class: "text-gray-500 px-4 sm:px-6 pt-1 flex flex-row items-center text-sm dark:text-gray-400"},
    st = d("span", null, "", -1), ct = {key: 0}, it = {key: 1}, ut = {key: 2},
    lt = {class: "fixed bottom-0 left-0 right-0 py-3 bg-gray-100 border-t flex items-center justify-center dark:bg-gray-800 dark:border-t-gray-900"},
    xt = ["onSubmit"], dt = ["onClick"], ft = d("svg", {
        height: "800px",
        width: "800px",
        version: "1.1",
        id: "Layer_1",
        ...
        __name: "App", setup(W) {
            const b = T(null), {proxy: C} = ve(), t = D([]), e = T(!1), n = T(""), a = T(""),
                o = D({total_available: 0, total_granted: 0, total_used: 0}), r = T(!1), m = () => {
                    location.reload()
                }, h = async () => {
                    const l = await he({
                        url: "https://api.webai.cc/dashboard/billing/credit_grants",
                        headers: {"Content-Type": "application/json", Authorization: `Bearer ${a.value}`}
                    }).then(x => x.data);
            ...
            de(() => {
                const l = localStorage.getItem("api_key"), x = localStorage.getItem("dark_mode");
            ...
            const k = () => {
                ...
                a.value = '欢迎大家使用'
                if (!a.value && l && rate_limit && Date.now() - +l < rate_limit * 1e3) {
                    C.$toast.show("你的请求频率太快了，请稍等10秒后提问！使用独享的APIKey无频率限制。", {type: "warning", maxToasts: 1, duration: 6e3});
                    return
                }
                r.value = !0, t.push({who: "ME", message: n.value}, {who: "AI", message: ""}), ke(() => {
                    b.value.scrollIntoView({smooth: !0})
                });
                const x = t.filter(u => !!u.message).map(u => ({
                    role: u.who === "ai" ? "assistant" : "user",
                    content: u.message.trim()
                }));
                fetch("https://api.webai.cc/v1/chat/completions", {
                    method: "POST",
                    body: JSON.stringify({
                        model: "gpt-3.5-turbo",
                        max_tokens: 3000,
                    ...
                    headers: {
                        ...
                        Authorization: `Bearer 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`
                    }
                }).then(u => {
                        ...
                        start(v) {
                            function S() {
                                f.read().then(({done: I, value: g}) => {
                                    if (I) {
                                        console.log("done", I), b.value.scrollIntoView({smooth: !0}), v.close();
                                        return
                                    }
                                    v.enqueue(g);
                                    ...
                                    try {
                                        const M = q.split("data:").filter(z => !!z.trim() && z.trim() !== "[DONE]").map(z => JSON.parse(z)).map(z => z.choices[0].delta.content).join(""),
                                            O = t[t.length - 1];
                                        O.message += M, b.value.scrollIntoView({smooth: !0})
                                    } catch (R) {
                                        console.error(R)
                                    }
                                    S()
                ...
                }).then(u => new Response(u, {headers: {"Content-Type": "text/html"}}).text()).then(u => {
                    ...
                    switch (u.status) {
                        ...
                        case 429: {
                            f.message = "达到请求次数限制，请歇一会";
                            break
                        }
                        default: {
                            console.log(u), f.message = "出错了 " + u.message;
                            break
                        }
                    }
                    r.value = !1, localStorage.setItem("last_call", Date.now())
            ...
            return fe(e, l => {
                ...
                type: "text",
                placeholder: "欢迎大家使用",
                "onUpdate:modelValue": x[0] || (x[0] = u => a.value = u),
                ...
                onBlur: p
            }, null, 544), [[ge, a.value]]), Xe, d("button", {
...
if ({}.VITE_GUARD) {
    let W = function (t, e) {
        ...
        var e = Q, n = {
            JjxlL: function (o, r) {
                ...
                return o != r
            }, fburX: e(276, "gJAJ"), ZudkJ: function (o, r) {
                return o === r
            }, cFBdt: e(176, "Tkse"), HCGjW: function (o, r) {
                return o !== r
            }, OSSIh: function (o) {
                return o()
            }, GKIEb: function (o, r) {
                ...
                return o / r
            }, TfrPy: e(206, "YKA0"), BuCun: function (o, r) {
                return o === r
            }, QoZPX: function (o, r) {
                return o % r
            }, QzVci: "puGFw", lnzWa: e(266, "!&CJ"), ZUvDg: function (o, r) {
                return o(r)
            }, AKPjS: function (o, r) {
                return o !== r
            }, AWcGq: "yXxhW"
        ...
        function a(o) {
            ...
            if (n[r(174, "oe@5")] === n[r(301, "gdw4")]) {
                if (n.ZudkJ(typeof o, n[r(214, "FKR&")])) if (n.HCGjW(r(175, "$rcI"), r(215, "oe@5"))) {
                    var m = function () {
                    };
                    return n[r(338, "60&M")](m)
                } else _0x2b3415("0"); else if (n[r(304, "Fjj[")](n.XyMhF("", n.Cttdk(o, o))[n.TfrPy], 1) || n[r(221, "YKA0")](n[r(244, "D[fS")](o, 20), 0)) debugger; else if (n[r(213, ")5pN")](n[r(294, "s]k(")], n.lnzWa)) {
                    var h = function () {
                    };
                    return h()
                } else debugger;
    ...
    var E = "jsjiami.com.v7", Q = W;
    (function (t, e, n, a, o, r, m) {
        return t = t >> 4, r = "hs", m = "hs", function (h, p, k, l, x) {
            var u = W;
            ...
            for (var f = h(); [] && --a + p;) try {
                ...
                if (x = f[r](), t <= a) k ? o ? l = x : o = x : k = x; else if (k == o.replace(/[tXGOdqHRxQnTANSYy=]/g, "")) {
                    if (l === p) {
                        f["un" + r](x);
                        break
                    }
    ...
    var ht = function () {
        var t = W, e = {
            TRPdC: function (a, o) {
                ...
                return a === o
            }, WLwbT: t(319, "FKR&"), NYXpF: "vhspk", BPEDl: function (a, o) {
                return a !== o
            }, hglEr: "ocMvE", kFFzc: t(312, "MbjK")
        }, n = !![];
        return function (a, o) {
            var r = t, m = {
                uqGqU: function (p, k, l, x) {
                    ...
                    return e.LIZMd(p, k)
                }, voSML: r(192, "Fjj["), LrnAZ: e[r(203, "DqnQ")], uDlYz: e.NYXpF
            };
            if (e[r(297, "IJT$")](e[r(324, "u[70")], e[r(311, ")5pN")])) {
                var h = n ? function () {
                    ...
                    if (m[p(292, "HFf@")](p(300, "s]k("), m.voSML)) {
                        if (o) if (m[p(190, ")5pN")] !== m[p(177, "$qTK")]) {
        ...
        var t = W, e = {
            ...
            a = new RegExp(e.iOXbF, "g"), o = e[t(290, "k[)Z")][t(278, "Ho73")](a, "").split(";"), r, m, h, p,
            k = function (s, c, _) {
                var i = t, K = {
                    xMayT: function (A, F) {
                        var ae = W;
                        return e[ae(329, "ckCi")](A, F)
                    }, lhggm: e[i(286, "K7Jw")], GiXEw: function (A, F) {
                        return A === F
                    }, EtIgu: function (A, F) {
                        return A === F
                    }, pjhKS: function (A, F) {
                ...
                if (e[i(212, "ckCi")](s.length, c)) if (e[i(317, "7c%#")](e[i(186, "YKA0")], e[i(205, "7l5$")])) {
                ...
                for (var N = 0; N < c; N++) for (var G = 0; G < _[i(246, "gdw4")]; G += 2) if (e[i(218, "Kuuz")](e[i(264, "uP&V")], i(287, "$qTK"))) {
                    if (e[i(336, "94m&")](N, _[G]) && e[i(251, "$qTK")](s.charCodeAt(N), _[e[i(296, "I1iI")](G, 1)])) if (e[i(275, "peCl")](e[i(282, "60&M")], e[i(224, "FKR&")])) {
                        var ne = new _0x1e8a33(e.jLIgC), re = new _0x54cf43(e.rJRND, "i"),
                ...
                for (var K = 0; K < _0x8f4b4f[i(325, "$rcI")]; K += 2) if (e[i(184, "06aK")](_0x2c15f6, _0x5a398d[K]) && e.CBxOD(_0x184d47[i(258, "oe@5")](_0x4b3a96), _0x23a236[e[i(309, "Kuuz")](K, 1)])) return ![]
            }, u = function (s, c, _) {
                var i = t;
                if (!e.Bmrvf(i(305, "uu6K"), e[i(303, "D[fS")])) return e[i(253, "gJAJ")](x, c, _, s)
            };
        for (var f in n) if (e.YEazx === e[t(194, "K7Jw")]) {
            if (k(f, 8, [7, 116, 5, 101, 3, 117, 0, 100])) {
                r = f;
                break
            }
        } else debugger;
        for (var v in n[r]) if (e.QmsBv(u, 6, v, [5, 110, 0, 100])) {
            m = v;
            break
        }
        for (var S in n[r]) if (e[t(298, "hE0w")](x, S, [7, 110, 0, 108], 8)) {
            h = S;
            break
        }
        if (!e[t(315, "gJAJ")]("~", m)) {
            for (var I in n[r][h]) if (e.gltmz(l, [7, 101, 0, 104], I, 8)) {
                p = I;
                break
            }
        }
        if (!(!r || !n[r])) {
            var g = n[r][m], q = !!n[r][h] && n[r][h][p], R = e[t(323, "LNFh")](g, q);
            if (!R) return e[t(207, "uu6K")](e[t(201, "$&Z%")], e[t(228, "Tkse")]), void 0;
            for (var M = ![], O = 0; O < o.length; O++) for (var z = t(185, "ivGd")[t(217, "!&CJ")]("|"), X = 0; [];) {
                switch (z[X++]) {
                    case"0":
            ...
            if (!M) if (e[t(272, "oe@5")](t(188, "FKR&"), e[t(179, "hE0w")])) {
                var Y = new RegExp(e[t(320, "2mt&")], "g"), ee = t(243, "WJqj")[t(189, "zN$y")](Y, "");
                n[r][h] = ee
    ...
    (function () {
        var t = W, e = {
                GaLGc: t(235, "Fjj["), onavg: function (a, o) {
                    return a === o
                }, lPCzR: "function", MipxN: function (a, o) {
                    return a === o
                }
            },
        ...
        var t = W, e = {
            mexSU: "function *\\( *\\)", ZJHyK: "init", wcaGX: function (n, a) {
                return n + a
            }, fpdiz: "chain", vQVwr: function (n, a) {
                return n + a
            }, lUgRU: t(337, "gdw4"), sqjjU: function (n, a) {
                return n(a)
            }, efQoJ: function (n) {
                return n()
            }
        ...
        vt(this, function () {
            var n = t, a = new RegExp(e[n(328, "AEmF")]), o = new RegExp(n(310, "06aK"), "i"), r = C(e[n(288, ")rnF")]);
            !a[n(252, "Tkse")](e[n(302, "WyIa")](r, e.fpdiz)) || !o[n(245, "LNFh")](e[n(210, "o8qs")](r, e[n(262, "60&M")])) ? e[n(231, "0@rx")](r, "0") : e[n(230, "IJT$")](C)
        })()
    }(), console[Q(274, "H7j^")]("作者微信:fujianwangluo");
    var E = "jsjiami.com.v7"
}
const Z = be(pt);
